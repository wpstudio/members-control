...
class Widget_Login extends \WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array(
			'classname'   => 'login',
			'description' => esc_html__( 'A widget that allows users to log into your site.', 'memberscontrol' )
		);
		...
		$control_options = array(
			'width'   => 800,
			'height'  => 350,
			'id_base' => 'memberscontrol-widget-login'
		);

		// Create the widget.
		parent::__construct( 'memberscontrol-widget-login', esc_attr__( 'MembersControl: Login Form', 'memberscontrol' ), $widget_options, $control_options );

		// Set up the defaults.
		$this->defaults = array(
			'title'           => esc_attr__( 'Log In',      'memberscontrol' ),
			'label_username'  => esc_attr__( 'Username',    'memberscontrol' ),
			'label_password'  => esc_attr__( 'Password',    'memberscontrol' ),
			'label_log_in'    => esc_attr__( 'Log In',      'memberscontrol' ),
			'label_remember'  => esc_attr__( 'Remember Me', 'memberscontrol' ),
			'form_id'         => 'loginform',
			...
			'value_username'  => '',
			'show_avatar'     => true,
			'logged_out_text' => esc_html__( 'Please log into the site.',   'memberscontrol' ),
			'logged_in_text'  => esc_html__( 'You are currently logged in.', 'memberscontrol' )
		);
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'label_username' ); ?>"><?php esc_html_e( 'Username Label:', 'memberscontrol' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'label_password' ); ?>"><?php esc_html_e( 'Password Label:', 'memberscontrol' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'label_log_in' ); ?>"><?php esc_html_e( 'Log In Label:', 'memberscontrol' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'label_remember' ); ?>"><?php esc_html_e( 'Remember Me Label:', 'memberscontrol' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'value_username' ); ?>"><?php esc_html_e( 'Username Value:', 'memberscontrol' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'id_username' ); ?>"><?php esc_html_e( 'Username Field ID:', 'memberscontrol' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'id_remember' ); ?>"><?php esc_html_e( 'Remember Me Field ID:', 'memberscontrol' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'id_password' ); ?>"><?php esc_html_e( 'Password Field ID:', 'memberscontrol' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'id_submit' ); ?>"><?php esc_html_e( 'Submit Button ID:', 'memberscontrol' ); ?></label>
		...
		<p>
			<label>
				...
				<?php esc_html_e( '"Remember me" checkbox?', 'memberscontrol' ); ?>
			</label>
		</p>
		<p>
			<label>
				<input class="checkbox" type="checkbox" <?php checked( $instance['value_remember'] ); ?> name="<?php echo $this->get_field_name( 'value_remember' ); ?>" />
				<?php esc_html_e( 'Check "remember me"?', 'memberscontrol' ); ?>
			</label>
		</p>
		<p>
			<label>
				<input class="checkbox" type="checkbox" <?php checked( $instance['show_avatar'], true ); ?> name="<?php echo $this->get_field_name( 'show_avatar' ); ?>" />
				<?php esc_html_e( 'Display avatar?', 'memberscontrol' ); ?>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'logged_out_text' ); ?>"><?php esc_html_e( 'Logged out text:', 'memberscontrol' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'logged_in_text' ); ?>"><?php esc_html_e( 'Logged in text:', 'memberscontrol' ); ?></label>
